...
Shaping the output is done in **`pubmed_transforms.yaml`** — dropping book/admin types, flattening list wrappers,
coercing booleans/timestamps, and serializing rich-text fields to markdown. See the
...
NLM — fetch from NLM directly for current data. Article abstracts within those records remain the copyright of their
publishers or authors; they are included solely as parser fixtures.
